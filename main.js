...
async function renderAdminPanel(isAdmin = false) {
  ...
  header.innerHTML = `
    ...
    <button onclick="logout()" style="margin-top:12px; padding:8px 18px; background:#e53e3e; color:white; border:none; border-radius:8px; cursor:pointer; font-size:14px;">
     Cerrar sesión
    </button>
  `
